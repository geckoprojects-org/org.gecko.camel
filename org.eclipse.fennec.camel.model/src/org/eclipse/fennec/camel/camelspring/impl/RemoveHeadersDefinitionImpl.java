 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.RemoveHeadersDefinitionImpl#getExcludePattern <em>Exclude Pattern</em>}</li>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.RemoveHeadersDefinitionImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoveHeadersDefinitionImpl extends NoOutputDefinitionImpl implements RemoveHeadersDefinition {
	...
	protected EClass eStaticClass() {
		return CamelSpringPackage.eINSTANCE.getRemoveHeadersDefinition();
	}
	...
	public void setExcludePattern(String newExcludePattern) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.REMOVE_HEADERS_DEFINITION__EXCLUDE_PATTERN, oldExcludePattern, excludePattern));
	}
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.REMOVE_HEADERS_DEFINITION__PATTERN, oldPattern, pattern));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CamelSpringPackage.REMOVE_HEADERS_DEFINITION__EXCLUDE_PATTERN:
				return getExcludePattern();
			case CamelSpringPackage.REMOVE_HEADERS_DEFINITION__PATTERN:
				return getPattern();
		}
