 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.FromDefinitionImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.FromDefinitionImpl#getVariableReceive <em>Variable Receive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FromDefinitionImpl extends OptionalIdentifiedDefinitionImpl implements FromDefinition {
	...
	protected EClass eStaticClass() {
		return CamelSpringPackage.eINSTANCE.getFromDefinition();
	}
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.FROM_DEFINITION__URI, oldUri, uri));
	}
	...
	public void setVariableReceive(String newVariableReceive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.FROM_DEFINITION__VARIABLE_RECEIVE, oldVariableReceive, variableReceive));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CamelSpringPackage.FROM_DEFINITION__URI:
				return getUri();
			case CamelSpringPackage.FROM_DEFINITION__VARIABLE_RECEIVE:
