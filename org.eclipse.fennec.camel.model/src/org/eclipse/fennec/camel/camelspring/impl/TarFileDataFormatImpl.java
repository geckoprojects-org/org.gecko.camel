...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tar File Data Format</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.TarFileDataFormatImpl#getAllowEmptyDirectory <em>Allow Empty Directory</em>}</li>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.TarFileDataFormatImpl#getMaxDecompressedSize <em>Max Decompressed Size</em>}</li>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.TarFileDataFormatImpl#getPreservePathElements <em>Preserve Path Elements</em>}</li>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.TarFileDataFormatImpl#getUsingIterator <em>Using Iterator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TarFileDataFormatImpl extends DataFormatImpl implements TarFileDataFormat {
	/**
	 ...
	 * @generated
	 */
	protected TarFileDataFormatImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CamelSpringPackage.eINSTANCE.getTarFileDataFormat();
	}
	...
	public void setAllowEmptyDirectory(String newAllowEmptyDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.TAR_FILE_DATA_FORMAT__ALLOW_EMPTY_DIRECTORY, oldAllowEmptyDirectory, allowEmptyDirectory));
	}
	...
	public void setMaxDecompressedSize(String newMaxDecompressedSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.TAR_FILE_DATA_FORMAT__MAX_DECOMPRESSED_SIZE, oldMaxDecompressedSize, maxDecompressedSize));
	}
	...
	public void setPreservePathElements(String newPreservePathElements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.TAR_FILE_DATA_FORMAT__PRESERVE_PATH_ELEMENTS, oldPreservePathElements, preservePathElements));
	}
	...
	public void setUsingIterator(String newUsingIterator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.TAR_FILE_DATA_FORMAT__USING_ITERATOR, oldUsingIterator, usingIterator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CamelSpringPackage.TAR_FILE_DATA_FORMAT__ALLOW_EMPTY_DIRECTORY:
				return getAllowEmptyDirectory();
			case CamelSpringPackage.TAR_FILE_DATA_FORMAT__MAX_DECOMPRESSED_SIZE:
				return getMaxDecompressedSize();
			case CamelSpringPackage.TAR_FILE_DATA_FORMAT__PRESERVE_PATH_ELEMENTS:
				return getPreservePathElements();
			case CamelSpringPackage.TAR_FILE_DATA_FORMAT__USING_ITERATOR:
