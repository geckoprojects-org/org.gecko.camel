...
import org.eclipse.fennec.camel.camelspring.AbstractCamelProducerTemplateFactoryBean;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.AbstractCamelProducerTemplateFactoryBeanImpl#getDefaultEndpoint <em>Default Endpoint</em>}</li>
 *   <li>{@link org.eclipse.fennec.camel.camelspring.impl.AbstractCamelProducerTemplateFactoryBeanImpl#getMaximumCacheSize <em>Maximum Cache Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCamelProducerTemplateFactoryBeanImpl extends AbstractCamelFactoryBeanImpl implements AbstractCamelProducerTemplateFactoryBean {
	...
	protected EClass eStaticClass() {
		return CamelSpringPackage.eINSTANCE.getAbstractCamelProducerTemplateFactoryBean();
	}
	...
	public void setDefaultEndpoint(String newDefaultEndpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.ABSTRACT_CAMEL_PRODUCER_TEMPLATE_FACTORY_BEAN__DEFAULT_ENDPOINT, oldDefaultEndpoint, defaultEndpoint));
	}
	...
	public void setMaximumCacheSize(int newMaximumCacheSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CamelSpringPackage.ABSTRACT_CAMEL_PRODUCER_TEMPLATE_FACTORY_BEAN__MAXIMUM_CACHE_SIZE, oldMaximumCacheSize, maximumCacheSize, !oldMaximumCacheSizeESet));
	}
	...
	public void unsetMaximumCacheSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CamelSpringPackage.ABSTRACT_CAMEL_PRODUCER_TEMPLATE_FACTORY_BEAN__MAXIMUM_CACHE_SIZE, oldMaximumCacheSize, MAXIMUM_CACHE_SIZE_EDEFAULT, oldMaximumCacheSizeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CamelSpringPackage.ABSTRACT_CAMEL_PRODUCER_TEMPLATE_FACTORY_BEAN__DEFAULT_ENDPOINT:
				return getDefaultEndpoint();
			case CamelSpringPackage.ABSTRACT_CAMEL_PRODUCER_TEMPLATE_FACTORY_BEAN__MAXIMUM_CACHE_SIZE:
