...
public class PipelineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PipelinePackage.PIPELINE_DEFINITION: {
			...
			case PipelinePackage.SERVICE_DEPENDENCY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Consumer Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Consumer Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConsumerConfiguration(ConsumerConfiguration object) {
		return null;
	}
